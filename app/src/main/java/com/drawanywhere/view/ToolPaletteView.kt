...
class ToolPaletteView(
    ...
    private fun buildToolbar() {
        ...
        addToolButton(DrawTool.PIXEL_ERASER)
        ...
        // === 操作 ===
        addUndoButton()
        addActionButton(R.drawable.ic_action_delete) { callback?.onClearClicked() }
        addActionButton(R.drawable.ic_action_save) { callback?.onSaveClicked() }
        addActionButton(R.drawable.ic_action_close) { callback?.onCloseClicked() }
        addExitButton()
        addDivider()
    ...
    private fun toolIconRes(tool: DrawTool): Int = when (tool) {
        DrawTool.PEN -> R.drawable.ic_tool_pen
        DrawTool.ERASER -> R.drawable.ic_tool_eraser
        DrawTool.PIXEL_ERASER -> R.drawable.ic_tool_pixel_eraser
        DrawTool.LINE -> R.drawable.ic_tool_line
        DrawTool.DASHED_LINE -> R.drawable.ic_tool_dashed_line
        DrawTool.WAVE_LINE -> R.drawable.ic_tool_wave_line
        DrawTool.RECT -> R.drawable.ic_tool_rect
        DrawTool.CIRCLE -> R.drawable.ic_tool_circle
    }
    ...
    private fun addActionButton(iconRes: Int, onClick: () -> Unit) {
        val size = dp(40)
        val icon = ImageView(context).apply {
